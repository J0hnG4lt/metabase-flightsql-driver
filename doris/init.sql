-- Doris sample data for the Flight SQL driver tests.
-- Doris "databases" are what Metabase sees as schemas (the default `internal`
-- catalog holds them). Three databases mirror the GizmoSQL layout so the
